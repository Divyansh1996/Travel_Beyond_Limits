...
<div class='div2'>
    ...
    <center><span style='color:green;position:relative;top:50px;font-size:40px;'>Images of <?php
      ...
      include 'dbcon1.php';
      $qry="select * from image where i_id between 25 and 30";
      $result=  mysql_query($qry, $con);
    ...
    <center><span style='color:green;position:relative;top:260px;right:160px;font-size:40px;text-align:center; '>History of <?php
      ...
      ?> </span></center>
    <br>
    <p style='position:relative;left:10px;top:160px;font-size:25px;float:left;'><?php
      include 'dbcon1.php';
      $qry="select * from place where p_id=42";
      $result=  mysql_query($qry, $con);
      $row=  mysql_fetch_array($result);
      echo $row["p_history"];
      ?> </p> <br><br>
    <span style="color:green;font-size:30px;position:relative;top:500px;right:300px; ">Near By Hotels: </span>
    <?php
include 'dbcon1.php';
$qry="select * from place where p_id=42";
$result=  mysql_query($qry, $con);
$row=  mysql_fetch_array($result);
echo '<br><br>';
echo'<span style="position:relative;top:500px;right:300px;font-size:30px;">';
echo $row["p_hotel"];
echo '</span>'
    ?>
</div>
...
<div class="vticker" style="height:1000px;">
    <?php
            ...
            include 'dbcon1.php';
    $qry2="select * from comment,user where user.u_id=comment.u_id and comment.p_id=42";
...
<div class="div3" style="position:relative;bottom:35px;height:600px;">
    ...
    <form name="read" action="read1.php" method="POST" enctype="multipart/form-data">
