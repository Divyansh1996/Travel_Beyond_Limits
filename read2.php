...
<div class='div2'>
    ...
    <center><span style='color:green;position:relative;top:50px;font-size:40px;'>Images of <?php
      ...
      include 'dbcon1.php';
      $qry="select * from image where i_id between 13 and 18";
      $result=  mysql_query($qry, $con);
    ...
    <p style='position:relative;left:10px;top:200px;font-size:25px;float:left;'><?php
      ...
      echo $row["p_history"];
      ?> </p> <br><br>
    <span style="color:green;font-size:30px;position:relative;top:700px;right:300px; ">Near By Hotels: </span>
    <?php
include 'dbcon1.php';
$qry="select * from place where p_id=40";
$result=  mysql_query($qry, $con);
$row=  mysql_fetch_array($result);
echo '<br><br>';
echo'<span style="position:relative;top:320px;left:270px;font-size:30px;">';
echo $row["p_hotel"];
echo '</span>'
    ?>
</div>
...
<div class="vticker" style="height:1000px;">
    <?php
            ...
            include 'dbcon1.php';
    $qry2="select * from comment,user where user.u_id=comment.u_id and comment.p_id=40";
