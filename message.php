            ...
            .i7
{
    ...
    <center><div class="div2">
            <input type="hidden" name="txtid" <?php
                        include 'dbcon1.php';
                        $qry4="select max(m_id)+1 as max_id from message";
                        $result4=mysql_query($qry4,$con);
                        $row4=  mysql_fetch_array($result4);
                        echo'value="'.$row4["max_id"].'"';
                        ?>><br><br>
            <span class="s2"> <?php
      include 'dbcon1.php';
      ...
      echo'<img src="upload/'.$row22["u_image"].'" class="i7">';
            ?>  Message Sent By  <?php
            include 'dbcon1.php';
            $qry="select * from message order by m_id desc limit 1";
            ...
            include 'dbcon1.php';
            $qry1="select * from message order by m_id desc limit 1";
            ...
            include 'dbcon1.php';
            $qry2="select * from message order by m_id desc limit 1";
            ...
            include 'dbcon1.php';
            $qry3="select * from message order by m_id desc limit 1";
